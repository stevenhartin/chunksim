"""`fray maps`: what is cached, and removing it.
...
from fray_claude.cli.common import emit_json
from fray_claude.model.summary import format_age
from fray_claude.store.cache import FETCHED, MapEntry, list_maps, remove_computed, remove_map
