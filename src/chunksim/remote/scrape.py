...
`chunksim estimate` spends comes from `heuristics/overrides.json`, a default in
...
`batch.save_unlock`'s reasoning applied again: `chunksim heuristics` and the GUI's
