...
**`Other` is the display name** (`display_name`), and `chunksim tasks` accepts
either.
"""
...
from chunksim.derive.active_tasks import _recorded
from chunksim.derive.challenges import CURRENT_CHUNK_SUFFIX
...
#: CLI shows. Both are accepted as a `chunksim tasks` argument.
