"""`chunksim diff`: the symmetric comparison of two cached maps.
...
**It reports both directions, which `chunksim unlock` deliberately does not.**
...
from chunksim.cli.common import derive_cached, digests, emit_json, error, load_state
from chunksim.cli.render import display_tasks, name_or_none, print_capped
from chunksim.derive.delta import BRANCHES, BranchDelta, MapSide, StateDelta, compare_maps
from chunksim.derive.other_tasks import display_name
