...
**`chunksim tasks <category>` branches four ways**, which is most of this module:
...
from chunksim.cli.common import derive_cached, emit_json, error, load_state
from chunksim.cli.render import display_tasks, print_capped, print_grouped
from chunksim.derive.task_names import strip_task_markup
from chunksim.derive.other_tasks import CATEGORIES as OTHER_CATEGORIES, CategoryTasks, display_name, task_text
from chunksim.derive.sections import describe_sections, expand_chunk_areas
from chunksim.derive.sources import CATEGORIES as SOURCE_CATEGORIES
...
def _resolve_other_category(category: str | None) -> str | None:
    ...
    case-insensitive so `chunksim tasks other` works like every other argument
